...
export default function CampaignTimer(props: Props) {
  return (
    <>
      <div class="w-full bg-primary flex flex-row justify-center items-center md:gap-9 gap-4 text-white p-4 flex-wrap">
        <input
          type="hidden"
        ...
        <Button class="w-fit p-2 rounded-none order-3 bg-secondary" href={props.button.href}>
          {props.button.label}
        </Button>
      </div>
      <script
